...
export class AuthService {
  ...
  private endpointURL="http://192.168.163.146:9200/api/v1/auth/"
  ...
  login(user: any): Observable<any> {  
   ...
   endpointpwd="http://192.168.163.146:9200/api/v1/"
  ...
  deleteUserById(userId: number): Observable<any> {
    const deleteUserUrl = `http://192.168.163.146:9200/api/v1/user/deleteId/${userId}`;
